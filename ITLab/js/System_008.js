...
System.Type.RegisterNamespace("System.IO.Directory");
...
System.Type.RegisterNamespace("System.IO.File");
...
System.IO.MemoryStream = function(buffer){
	...
	this.Read = function(buffer, offset, count){
		...
		/// <returns>The total number of bytes written into the buffer.</returns>
		if (isServerSide){
