...
<body>
        ...
        <div id="Buoc1">
            ...
            <div class="row">
                <div class="col-lg-11 col-lg-offset-1">
                    ...
                    <select name="ctl00$ContentPlaceHolder1$ddlLoaiDK" id="ContentPlaceHolder1_ddlLoaiDK" style="font-size:17px;">
	<option  value="0">-------------Chọn-------------</option>
	<option selected="selected" value="1">Máy tính</option>
    <option value="2">Bảng tương tác</option>
    <option value="3">Dây VGA(Bảng tương tác)</option>
    <option value="4">Mạng Internet</option>
    ...
    <script type="text/javascript">
        ...
        function ProcessIframe() {
            var iLoai = parseInt($('#ContentPlaceHolder1_ddlLoaiDK').val());
