<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewxulyhoantatlist.aspx.cs" Inherits="ITLab.admincp.viewxulyhoantatlist" %>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Hoàn tất xử lý
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2><strong><span class="style1">Danh sách xử lý hoàn tất </span></strong> <span class="badge badge-blue"> <%=Session["Msgxulyxong1"].ToString()%></span></h2>
