<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Xoaloaisuachua.aspx.cs" Inherits="ITLab.admincp.Xoaloaisuachua" %>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h2 class="style2"><strong>Xóa loại sửa chữa:</strong></h2>
                        <div class="table-responsive">
                            &nbsp;<table cellspacing="1" class="nav-justified">
                                <tr>
                                    ...
                                    <td>
                                       <button id="Button1" type="button" runat="server" class="btn btn-primary btn-sm"  onserverclick="btnXoaLoaiSc_Click"></span> Đồng ý</button>
                                    </td>
                                    <td>
                                        &nbsp;</td>
                                </tr>
