<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewdangxulylist.aspx.cs" Inherits="ITLab.admincp.viewdangxulylist" %>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Danh sách đang xử lý</li>
                        </ol>
                    </div>
                </div>
                <!-- /.row -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2>Danh sách đang xử lý <span class="badge badge-blue"><%= Session["Msgchuaxuly1"].ToString()%></span></h2>  
 ...
 <th class="style1">Chức năng</th>
                ...
                <td><a class="btn btn-success" href="viewxulylistdangxl.aspx?idcxl=<%#Eval("ID_CF") %>">Xử lý</td>
